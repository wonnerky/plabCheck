...
lookingMatches = []
lookingMatches.append(Matches('19:00', '용산 아이파크몰 (1구장/레알)'))
...
while 1:
    ...
    for i in range(len(elements)):
        ...
        # print(time_element.text,ground_element.text,status_element.text)
    ...
    #     print(nowMatches[i].time,nowMatches[i].ground,nowMatches[i].status)
